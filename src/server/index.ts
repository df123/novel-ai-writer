...
console.log('7. 注册 chatsRouter (路径: /api)');
app.use('/api', chatsRouter);
console.log('8. 注册 messagesRouter (路径: /api)');
app.use('/api', messagesRouter);
console.log('9. 注册 timelineRouter (路径: /api)');
app.use('/api', timelineRouter);
console.log('10. 注册 charactersRouter (路径: /api)');
app.use('/api', charactersRouter);
console.log('11. 注册 exportRouter (路径: /api)');
