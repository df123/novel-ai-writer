...
export const timelineEventOutput = z.object({
  ...
  title: z.string(),
  date: z.string(),
  description: z.string().describe('Legacy alias of content — always identical value (kept for web UI compatibility). Read content instead.'),
  content: z.string().optional().describe('Canonical event body text. Always read/write this field.'),
  orderIndex: z.number(),
  createdAt: ts,
  updatedAt: ts,
  deleted: z.boolean().optional(),
